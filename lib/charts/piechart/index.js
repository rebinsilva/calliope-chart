...
var PieChart = function(_Chart) {
    ...
    _createClass(PieChart, [{
        ...
        value: function displayProportion() {
            ...
            if (style === _style2.default.PICTOGRAPH) { //将名称存成数组  breakdown values
                var pictype = void 0;
        ...
        value: function displayDifference() {
            ...
            if (style === _style2.default.PICTOGRAPH) {
                var _ret = function() { //将名称存成数组  breakdown values
                    var pictype = [];
                    if (breakdown[0].type === "temporal" || breakdown[0].type === "numerical") return {
                        v: void 0
                    };
        ...
        value: function displayDistribution() {
            ...
            if (style === _style2.default.BUSINESS || style === _style2.default.COMICS) {
                ...
                if (this.size() === _size2.default.WIDE) {
                    ...
                    _foreignObject.attr("height", legendsHeight); //除legend以外的空间用来绘制pie
                    ...
                    _foreignObject.attr("y", 2.15 * R + textHeight); //center居中
            ...
            if (style === _style2.default.PICTOGRAPH) {
                var _ret3 = function() {
                    ...
                    if (size === _size2.default.WIDE) {
                        ...
                        _foreignObject3.attr("height", _legendsHeight); //除legend以外的空间用来绘制pie
                        ...
                        _foreignObject3.attr("y", 2.15 * R + _textHeight); //center居中
